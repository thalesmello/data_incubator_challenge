...
The goal of the project is to create a similar projects recommendation system that takes into account both stars and issues in the project. I will leverage my experience building data pipelines as Data Engineer to design a system that will update itself daily with data provided by the GitHub Archive.